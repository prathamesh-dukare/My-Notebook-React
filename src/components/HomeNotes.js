...
export default function HomeNotes() {
    ...
    const [currentNote, setCurrentNote] = useState({ title: "", description: "", tags: "" })
        ...
        <div>
            <div className="container my-3">
                <form className="container my-5" style={{ width: "55vw" }}>
                    ...
                    <div className="form-group my-2">
                        <input type="text" className="form-control" onChange={onChange} id="tags" name="tags" placeholder="Tags Goes here" />
                    </div>
                    <div className="container my-2 flex-container text-center">
                        ...
                        <button className="btn btn-outline btn-danger mx-2 my-1" ref={refReset} type="reset">Reset Details</button>
                    </div>
                </form>
                <Notes />
